...
# subset the SCC with coal values
...
# sum the emission data per year
totalEmissions <- tapply(NEISCC$Emissions, NEISCC$year, sum)
colors <- c("red", "green", "blue","yellow")

# plotting
barplot(totalEmissions, xlab = "Year", ylab = "Total Emission (ton)", main = "Total Emission from coal sources", col = colors)